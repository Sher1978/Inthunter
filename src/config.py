...
class Settings(BaseSettings):
    ...
    GEMINI_MODEL: str = Field(default_factory=lambda: os.getenv("GEMINI_MODEL", "gemini-1.5-flash"), alias="GEMINI_MODEL")
    ...
    GROQ_MODEL: str = Field(default_factory=lambda: os.getenv("GROQ_MODEL", "llama-3.1-70b-versatile"), alias="GROQ_MODEL")
