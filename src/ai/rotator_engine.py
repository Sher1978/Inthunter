...
class AIRotatorEngine:
    ...
    def get_configured_providers(self) -> List[Dict[str, Any]]:
        ...
        if gemini_keys:
            ...
            candidate_gemini = [gem_model, "gemini-1.5-flash", "gemini-2.0-flash", "gemini-1.5-pro"]
            providers.append({
                "name": "Gemini_REST",
                "base_url": "REST",
                "keys": gemini_keys,
        ...
        if groq_keys:
            g_model = getattr(settings, "GROQ_MODEL", "llama-3.1-70b-versatile")
            candidate_groq = [g_model, "llama-3.1-70b-versatile", "llama3-8b-8192", "groq/compound", "groq/compound-mini"]
    ...
    async def generate_completion(
        ...
        for provider in providers:
            ...
            if p_name == "Gemini_REST":
                ...
                gem_model = getattr(settings, "GEMINI_MODEL", "gemini-1.5-flash")
                models_to_try = list(dict.fromkeys([gem_model, "gemini-1.5-flash", "gemini-2.0-flash", "gemini-1.5-pro"]))
