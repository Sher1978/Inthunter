...
Input: "На месяц проше всего недорогой отель и просить скидку. Прям русских нет. Но есть аналоги. Обычно все спокойно"
Output: {"is_lead": false, "is_vendor": false, "is_vacancy": false, "niche": "REAL_ESTATE", "reasoning": "User is giving accommodation advice and hotel recommendations to someone else, not looking to book for themselves - NOISE/CHATTER."}
